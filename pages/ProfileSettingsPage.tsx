                ...
                footer={
                    <>
                        <button
                            ...
                            className="px-4 py-2 text-sm font-bold text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/10 rounded-lg transition-colors"
                        >
                            Cancel
                        </button>
                        <button
                            onClick={confirmPasswordReset}
                            className="px-4 py-2 text-sm font-bold text-white bg-primary hover:opacity-90 rounded-lg shadow-lg shadow-primary/30 transition-all"
                        >
                            Send Instructions
                        </button>
                    </>
